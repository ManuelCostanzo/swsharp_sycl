...
/*
DPCT1059:241: SYCL only supports 4-channel image format. Adjust the code.
*/
dpct::image_wrapper<char, 1> colTexture;
/*
DPCT1059:242: SYCL only supports 4-channel image format. Adjust the code.
*/
dpct::image_wrapper<sycl::int2, 1> hBusTexture;
/*
DPCT1059:243: SYCL only supports 4-channel image format. Adjust the code.
*/
...
solveShortDelegated(int d, VBus vBus, sycl::int2 *hBus, Sub sub,
                    ...
                    int dRow_, int subLen_, int *hBusScrShr, int *hBusAffShr,
...
solveShortDelegated(int d, VBus vBus, sycl::int2 *hBus, Sub sub,
    ...
    for (int i = 0; i < item_ct1.get_local_range(2); ++i) {
        ...
        if (0 <= row && row < rows_) {
            ...
            /*
            DPCT1084:246: The function call has multiple migration results in
            ...
            */
            ...
            /*
            DPCT1084:247: The function call has multiple migration results in
            different template instantiations that could not be unified. You may
            need to adjust the code.
            */
            ...
            /*
            DPCT1084:248: The function call has multiple migration results in
            different template instantiations that could not be unified. You may
            need to adjust the code.
            */
            ...
            /*
            DPCT1084:249: The function call has multiple migration results in
            different template instantiations that could not be unified. You may
            need to adjust the code.
            */
        ...
        */
        ...
        /*
        DPCT1065:245: Consider replacing sycl::nd_item::barrier() with
        sycl::nd_item::barrier(sycl::access::fence_space::local_space) for
        better performance if there is no access to global memory.
        */
        item_ct1.barrier();
...
solveShortNormal(int d, VBus vBus, sycl::int2 *hBus, Sub sub,
    ...
    for (int i = 0; i < item_ct1.get_local_range(2); ++i, ++col) {
        ...
        int ins = sycl::max((int)(atom.lScr.x() - gapOpen_),
                            (int)(atom.lAff.x() - gapExtend_));
        /*
        DPCT1084:252: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        int mch = atom.mch + sub(columnCode, rowCodes.x(), subLen_, subTexture);
        ...
        ins = sycl::max((int)(atom.lScr.y() - gapOpen_),
                        (int)(atom.lAff.y() - gapExtend_));
        /*
        DPCT1084:253: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        mch = atom.lScr.x() + sub(columnCode, rowCodes.y(), subLen_, subTexture);
        ...
        ins = sycl::max((int)(atom.lScr.z() - gapOpen_),
                        (int)(atom.lAff.z() - gapExtend_));
        /*
        DPCT1084:254: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        mch = atom.lScr.y() + sub(columnCode, rowCodes.z(), subLen_, subTexture);
        ...
        ins = sycl::max((int)(atom.lScr.w() - gapOpen_),
                        (int)(atom.lAff.w() - gapExtend_));
        /*
        DPCT1084:255: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        mch = atom.lScr.z() + sub(columnCode, rowCodes.w(), subLen_, subTexture);
...
static void solveShort(int d, VBus vBus, sycl::int2 *hBus, Sub sub,
    ...
    if (item_ct1.get_group(2) == (item_ct1.get_group_range(2) - 1)) {
        solveShortDelegated(d, vBus, hBus, sub, item_ct1, gapOpen_, gapExtend_,
                            dRow_, subLen_, hBusScrShr, hBusAffShr, rowTexture,
                            colTexture, hBusTexture, subTexture);
    } else {
        solveShortNormal(d, vBus, hBus, sub, item_ct1, subLen_, hBusScrShr,
                         hBusAffShr, rowTexture, colTexture, hBusTexture,
                         subTexture);
    }
}
...
static void solveLong(int d, VBus vBus, sycl::int2 *hBus, Sub sub,
    ...
    for (int i = 0; i < cellWidth_ - item_ct1.get_local_range(2); ++i, ++col) {
        ...
        int ins = sycl::max((int)(atom.lScr.x() - gapOpen_),
                            (int)(atom.lAff.x() - gapExtend_));
        /*
        DPCT1084:258: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        int mch = atom.mch + sub(columnCode, rowCodes.x(), subLen_, subTexture);
        ...
        ins = sycl::max((int)(atom.lScr.y() - gapOpen_),
                        (int)(atom.lAff.y() - gapExtend_));
        /*
        DPCT1084:259: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        mch = atom.lScr.x() + sub(columnCode, rowCodes.y(), subLen_, subTexture);
        ...
        ins = sycl::max((int)(atom.lScr.z() - gapOpen_),
                        (int)(atom.lAff.z() - gapExtend_));
        /*
        DPCT1084:260: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        mch = atom.lScr.y() + sub(columnCode, rowCodes.z(), subLen_, subTexture);
        ...
        ins = sycl::max((int)(atom.lScr.w() - gapOpen_),
                        (int)(atom.lAff.w() - gapExtend_));
        /*
        DPCT1084:261: The function call has multiple migration results in
        different template instantiations that could not be unified. You may
        need to adjust the code.
        */
        mch = atom.lScr.z() + sub(columnCode, rowCodes.w(), subLen_, subTexture);
...
static void *kernel(void *params) try {
    ...
    if (currentCard != card) {
        ...
        /*
        DPCT1093:262: The "card" may not be the best XPU device. Adjust the
        selected device if needed.
        */
        /*
        DPCT1003:263: Migrated API does not return error code. (*, 0) is
    ...
    */
    ...
    int blocks;
    /*
    DPCT1005:265: The SYCL device version is different from CUDA Compute
    ...
    */
    ...
    /*
    DPCT1003:268: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
    ...
    */
    CUDA_SAFE_CALL((colGpu = (char *)sycl::malloc_device(
                    ...
                    0));
    /*
    DPCT1003:270: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
    CUDA_SAFE_CALL(
    ...
    */
    ...
    /*
    DPCT1003:275: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
    ...
    */
    ...
    for (int diagonal = 0; diagonal < diagonals; ++diagonal) {
        if (scalar) {
            /*
            DPCT1049:284: The work-group size passed to the SYCL kernel may
            ...
            */
                ...
                cgh.parallel_for(
                    ...
                    [=](sycl::nd_item<3> item_ct1) {
                        solveShort(
                            ...
                            item_ct1, *gapOpen__ptr_ct1, *gapExtend__ptr_ct1,
            ...
            /*
            DPCT1049:285: The work-group size passed to the SYCL kernel may
            exceed the limit. To get the device limit, query
            info::device::max_work_group_size. Adjust the work-group size if
            needed.
            */
            dpct::get_default_queue().submit([&](sycl::handler &cgh) {
                ...
                cgh.parallel_for(
                    sycl::nd_range<3>(sycl::range<3>(1, 1, blocks) *
                                      ...
                                      sycl::range<3>(1, 1, threads)),
                    [=](sycl::nd_item<3> item_ct1) {
                        solveLong(diagonal, vBusGpu, hBusGpu, SubScalarRev(),
            ...
            /*
            DPCT1049:286: The work-group size passed to the SYCL kernel may
            exceed the limit. To get the device limit, query
            info::device::max_work_group_size. Adjust the work-group size if
            needed.
            */
            ...
            /*
            DPCT1049:287: The work-group size passed to the SYCL kernel may
            exceed the limit. To get the device limit, query
            info::device::max_work_group_size. Adjust the work-group size if
            needed.
            */
    ...
    */
    ...
    /*
    DPCT1003:290: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
    CUDA_SAFE_CALL((hBusTexture.detach(), 0));
    /*
    DPCT1003:291: Migrated API does not return error code. (*, 0) is inserted.
    You may need to rewrite this code.
    */
