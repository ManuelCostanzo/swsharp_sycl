    ...
    for (int diagonal = 0; diagonal < diagonals; ++diagonal)
    {
        ...
        if (scalar)
        {
          ...
          cgh.parallel_for(sycl::nd_range<1>(blocks*threads, threads),
                ...
                solveShort(
                    diagonal, vBusGpu, hBus, results, SubScalar(),
                    item_ct1, *ga, *ge, rowsGpu, colsGpu, cellWidth, pruneLow, pruneHigh,
     ...
     cgh.parallel_for(sycl::nd_range<1>(blocks*threads, threads),
                       [=](sycl::nd_item<1> item_ct1) {
                solveLong(
                    diagonal, vBusGpu, hBus, b, results, SubScalar(),
                    item_ct1, *ga, *ge, rowsGpu, colsGpu, cellWidth, pruneLow, pruneHigh,
                    scorerLen, subLen,match, mismatch, hBusScrShr_acc_ct1.get_pointer(),
                    hBusAffShr_acc_ct1.get_pointer(), rowGpu, colGpu, sub);
              }); })
     ...
     cgh.parallel_for(sycl::nd_range<1>(blocks*threads, threads),
                       [=](sycl::nd_item<1> item_ct1) {
                solveShort(
                    diagonal, vBusGpu, hBus, results, SubScalarRev(),
                    item_ct1, *ga, *ge, rowsGpu, colsGpu, cellWidth, pruneLow, pruneHigh,
                    scorerLen, subLen,match, mismatch, hBusScrShr_acc_ct1.get_pointer(),
                    hBusAffShr_acc_ct1.get_pointer(), rowGpu, colGpu, sub);
              }); })
     ...
     cgh.parallel_for(sycl::nd_range<1>(blocks*threads, threads),
                       [=](sycl::nd_item<1> item_ct1) {
                solveLong(
                    diagonal, vBusGpu, hBus, b, results, SubScalarRev(),
                    item_ct1, *ga, *ge, rowsGpu, colsGpu, cellWidth, pruneLow, pruneHigh,
                    scorerLen, subLen,match, mismatch, hBusScrShr_acc_ct1.get_pointer(),
                    hBusAffShr_acc_ct1.get_pointer(), rowGpu, colGpu, sub);
              }); })
        ...
        sycl::accessor<int, 1, sycl::access_mode::read_write,
         ...
         cgh.parallel_for(sycl::nd_range<1>(blocks*threads, threads),
                       [=](sycl::nd_item<1> item_ct1) {
                solveShort(
                    diagonal, vBusGpu, hBus, results, SubVector(),
                    item_ct1, *ga, *ge, rowsGpu, colsGpu, cellWidth, pruneLow, pruneHigh,
                    scorerLen, subLen,match, mismatch, hBusScrShr_acc_ct1.get_pointer(),
                    hBusAffShr_acc_ct1.get_pointer(), rowGpu, colGpu, sub);
            }); })
        ...
        sycl::accessor<int, 1, sycl::access_mode::read_write,
         ...
         cgh.parallel_for(sycl::nd_range<1>(blocks*threads, threads),
                       [=](sycl::nd_item<1> item_ct1) {
                solveLong(
                    diagonal, vBusGpu, hBus, b, results, SubVector(),
                    item_ct1, *ga, *ge, rowsGpu, colsGpu, cellWidth, pruneLow, pruneHigh,
                    scorerLen, subLen,match, mismatch, hBusScrShr_acc_ct1.get_pointer(),
                    hBusAffShr_acc_ct1.get_pointer(), rowGpu, colGpu, sub);
            }); })
